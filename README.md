...
```go
import "github.com/StreamElements/squirrel"
```


[![GoDoc](https://godoc.org/github.com/StreamElements/squirrel?status.png)](https://godoc.org/github.com/StreamElements/squirrel)
...
```go
import sq "github.com/StreamElements/squirrel"
...
* **How can I build an IN query on composite keys / tuples, e.g. `WHERE (col1, col2) IN ((1,2),(3,4))`? ([#104](https://github.com/StreamElements/squirrel/issues/104))**
...
* **Why doesn't `Eq{"mynumber": []uint8{1,2,3}}` turn into an `IN` query? ([#114](https://github.com/StreamElements/squirrel/issues/114))**
